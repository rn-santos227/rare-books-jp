...
export const en: Translations = {
  ...
  catalog: {
    ...
    advancedHelper: "Combine keywords, categories, and genres to build an advanced search.",
    gridView: "Grid view",
    listView: "List view",
    splitView: "Two-Panels view",
    activeLabel: "Active",
  ...
  filters: {
    ...
    genres: "Genres",
    dropdownHelper: "Use the dropdowns to gather every tag in one place.",
    categoriesPlaceholder: "Choose categories to include",
    genresPlaceholder: "Choose genres to include",
  ...
  order: {
    ...
    contactNumberPlaceholder: "Include country/area code (e.g. +81 90 1234 5678)",
  ...
  reviews: {
    ...
    emailPlaceholder: "We only use this to follow up about your review.",
    titleLabel: "Title (optional)",
    titlePlaceholder: "Summarize your thoughts in a few words",
